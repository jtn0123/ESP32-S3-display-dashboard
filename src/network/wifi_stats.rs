...
static WIFI_LAST_DISC_MS: AtomicU64 = AtomicU64::new(0);
...
pub fn record_disconnect() {
    ...
    unsafe {
        ...
        WIFI_LAST_DISC_MS.store(ms, Ordering::Relaxed);
    }
}
...
pub fn snapshot() -> WifiStatsSnapshot {
    WifiStatsSnapshot {
        ...
        last_disconnect_ms: WIFI_LAST_DISC_MS.load(Ordering::Relaxed),
    }
}
