...
// Atomics are 32-bit on Xtensa; store last disconnect time in ms truncated to u32 (wraps ~49 days)
use core::sync::atomic::AtomicU32 as AtomicU64Compat;
...
pub fn record_disconnect() {
    ...
    unsafe {
        ...
        WIFI_LAST_DISC_MS.store((ms & 0xFFFF_FFFF) as u32, Ordering::Relaxed);
    }
}
